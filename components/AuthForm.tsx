                ...
                <div>
                  ...
                  <div className="relative group/input">
                    <input
                      ...
                      type="text"
                      {...register('name')}
                      className={`w-full bg-slate-950/50 border ${errors.name ? 'border-red-500' : 'border-slate-700/50'} 
          ...
          <div className="mt-6">
            ...
            <div className="mt-2">
              <button
                ...
                disabled={loading}
                className="w-full bg-slate-800/10 dark:bg-slate-800/50 border border-slate-700/50 hover:bg-slate-800 text-slate-300 py-3 rounded-xl transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed group"
              >
