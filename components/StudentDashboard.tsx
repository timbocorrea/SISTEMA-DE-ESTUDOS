  ...
  return (
    <div className="p-4 md:p-8 space-y-8 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          {/* Using WeeklySummary for greeting/stats, so minor header here or rely on WeeklySummary */}
        </div>
        {user.role === 'INSTRUCTOR' && (
          <button
            onClick={onManageContent}
            className="self-end md:self-auto px-5 py-3 rounded-2xl bg-indigo-600 hover:bg-indigo-500 text-white font-black text-sm uppercase tracking-wider shadow-lg shadow-indigo-600/20 transition-all hover:scale-105 active:scale-95"
          >
